[index.html](https://github.com/user-attachments/files/24680080/index.html)
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="content">
                <div class="banner-content">
                    ...
                    <p class="pg-banner">Reunion7, created by the creators of Reloaded7 and Classic 7 is a mod<br>
                       based off Windows 10 LTSC 2021 that replicates Windows 7.</p>
                ...
                <div class="content-cards">
                    ...
                    <div class="cards">
                        ...
                        <div class="card">
                            ...
                            <a href="specs.html" class="card-header-link">Got new hardware?</a>
                            <p>Reunion7 supports new hardware unlike Windows 7.<a href="specs.html"> Click here</a> to learn more.</p>
                        </div>
                        <div class="card">
                            <img src="Assets/dsc.png" class="showcase-img">
                            <a href="#" class="card-header-link">Need support?</a>
                            <p>Our great community on <a href="https://discord.gg/dXVHnz2My9">Discord</a> can help you out at any time if you need assistance with anything!</p>
                        </div>
                    </div>
                </div>
                <div class="extras">
                    ...
                    <div class="list">
                        <ul>
                            <li><a href="https://crosstalk.im">Windows Live Messenger</a></li>
                        </ul>
                    </div>
                </div>
            </div>
